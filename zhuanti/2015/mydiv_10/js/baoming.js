...
function checkzmn_from() {
            	if(document.zmn_from.zmn_name.value=='' || document.zmn_from.zmn_name.value=='姓　名'){
            		alert('请填写您的姓名');
            		document.zmn_from.zmn_name.focus();
            		return false;
            	}
				 if(document.zmn_from.zmn_tel.value=='' || document.zmn_from.zmn_tel.value=='电　话'){
            		alert('请填写您的电话');
            	...
            	if(document.zmn_from.zmn_city.value=='' || document.zmn_from.zmn_city.value=='城市'){
            		alert('请填写您所在的城市');
            		document.zmn_from.zmn_city.focus();
            		return false;
            	}	
