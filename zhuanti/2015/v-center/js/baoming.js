...
function checkzmn_from() {
            	if(document.zmn_from.zmn_name.value=='' || document.zmn_from.zmn_name.value==''){
            		alert('请填写您的姓名');
            		document.zmn_from.zmn_name.focus();
            		return false;
            	}
				 if(document.zmn_from.zmn_tel.value=='' || document.zmn_from.zmn_tel.value==''){
            		alert('请填写您的电话');
				 ...
				 if(document.zmn_from.zmn_city.value=='' || document.zmn_from.zmn_city.value==''){
            		alert('请正确填写您的地址');
            		 document.zmn_from.zmn_city.focus();
            		return false;
            	}						
				 if(document.zmn_from.zmn_zdschool.value=='' || document.zmn_from.zmn_zdschool.value==''){
            		alert('请填写您所就读的年级');
            		 document.zmn_from.zmn_zdschool.focus();
            		return false;
            	}					
	return true;   
}
